...
const Receita:React.FC<ReceitaProps> = (
    ...
    return (
        ...
        <div className="w-full flex justify-center items-center">
            ...
            <div className="w-20 h-120 bg-[#FE9D0E] rounded-full mr-7 flex flex-col pt-10 items-center shadow-2xl absolute z-20">
                <i className="fas fa-sun text-4xl text-white"></i>
                <hr className="mt-3 border-2 w-[70]"/>
                
            </div>
            <div className="w-full h-[600] shadow-2xl pl-10 pr-2 py-10 relative z-10 ">
